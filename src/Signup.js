...
import Datatable from "./DatatableOld"
...
function Signup() {
    ...
    function createAccount() {
            ...
            axios({
                ...
                method:"post",
                data:user
            }).then((response)=>{console.log("Email created", response)},
                (error)=>{console.log("unable to create email", error)})
    ...
    return (
        ...
        <Datatable deleteUser={deleteUser} data={users} />
        </>
